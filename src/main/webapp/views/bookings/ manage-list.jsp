...
<main class="container">
    <div class="section-title"><h2>Quản lý đặt phòng</h2><span class="muted">Xác nhận, nhận phòng, hủy đặt phòng</span></div>
    ...
    <c:choose>
        <c:when test="${empty bookings}">
            <div class="empty panel">Không có đặt phòng phù hợp.</div>
        </c:when>
        <c:otherwise>
                    ...
                    <tbody>
                        <c:forEach var="b" items="${bookings}">
                            <tr>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${b.trangThai == 'Đã hủy'}"><span class="status bad">${b.trangThai}</span></c:when>
                                        <c:when test="${b.trangThai == 'Chờ xác nhận'}"><span class="status warn">${b.trangThai}</span></c:when>
